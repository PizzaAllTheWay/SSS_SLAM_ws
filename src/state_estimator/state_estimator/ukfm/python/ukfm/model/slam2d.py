...
class SLAM2D:
    ...
    max_range = 5
    r"""maximal range of observation (m).r"""
    min_range = 1
    r"""minimal range of observation (m).r"""
    N_ldk = 20
    r"""number of landmarks :math:`L`.r"""

    class STATE:
        r"""State of the system.
    ...
    class INPUT:
        r"""Input of the propagation model.
    ...
    @classmethod
    def h(cls, state):
        r"""Observation function for 1 landmark.
    ...
    def aug_z(cls, state, y):
        r"""Augmentation function. Return the augmented state.
    ...
    def aug_phi(cls, state, xi):
        r"""Retraction used for augmenting state.
    ...
    def up_phi(cls, state, xi):
        r"""Retraction used for updating state and infering Jacobian.
