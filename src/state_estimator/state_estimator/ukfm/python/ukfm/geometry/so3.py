...
class SO3:
    r"""Rotation matrix in :math:`SO(3)`
    ...
    @classmethod
    def Ad(cls, Rot):
        r"""Adjoint matrix of the transformation.
    ...
    @classmethod
    def exp(cls, phi):
        r"""Exponential map for :math:`SO(3)`, which computes a transformation 
    ...
    def inv_left_jacobian(cls, phi):
        r""":math:`SO(3)` inverse left Jacobian
    ...
    @classmethod
    def log(cls, Rot):
        r"""Logarithmic map for :math:`SO(3)`, which computes a tangent vector 
    ...
    @classmethod
    def to_rpy(cls, Rot):
        r"""Convert a rotation matrix to RPY Euler angles 
        :math:`(\\alpha, \\beta, \\gamma)`.r"""
    ...
    @classmethod
    def vee(cls, Phi):
        r""":math:`SO(3)` vee operator as defined by 
    ...
    @classmethod
    def wedge(cls, phi):
        r""":math:`SO(3)` wedge operator as defined by 
        :cite:`barfootAssociating2014`.
    ...
    def from_rpy(cls, roll, pitch, yaw):
        r"""Form a rotation matrix from RPY Euler angles 
    ...
    def rotx(cls, angle_in_radians):
        r"""Form a rotation matrix given an angle in rad about the x-axis.
    ...
    def roty(cls, angle_in_radians):
        r"""Form a rotation matrix given an angle in rad about the y-axis.
    ...
    def rotz(cls, angle_in_radians):
        r"""Form a rotation matrix given an angle in rad about the z-axis.
