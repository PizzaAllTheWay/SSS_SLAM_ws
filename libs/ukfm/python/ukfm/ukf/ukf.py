...
class UKF:
    r"""The Unscented Kalman Filter on (parallelizable) Manifolds.
...
class JUKF:
    ...
    def F_num(self, omega, dt):
        r"""Numerical Jacobian computation of :math:`\mathbf{F}`.
    ...
    def G_num(self, omega, dt):
        r"""Numerical Jacobian computation of :math:`\mathbf{G}`.
    ...
    def update(self, y, R):
        r"""State update, where Jacobian is computed.
    ...
    def H_num(self, y, idxs, R):
        r"""Numerical Jacobian computation of :math:`\mathbf{H}`.
    ...
    def state_update(self):
        r"""State update, once Jacobian is computed.
        r"""
