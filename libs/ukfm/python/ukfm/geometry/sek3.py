...
class SEK3:
    r"""Homogeneous transformation matrix in :math:`SE_k(3)`.
    ...
    @classmethod
    def exp(cls, xi):
        r"""Exponential map for :math:`SE_k(3)`, which computes a transformation 
    ...
    @classmethod
    def log(cls, chi):
        r"""Logarithmic map for :math:`SE_k(3)`, which computes a tangent vector 
