...
class SE2:
    r"""Homogeneous transformation matrix in :math:`SE(2)`
    ...
    @classmethod
    def exp(cls, xi):
        r"""Exponential map for :math:`SE(2)`, which computes a transformation
    ...
    @classmethod
    def log(cls, chi):
        r"""Logarithmic map for :math:`SE(2)`, which computes a tangent vector 
