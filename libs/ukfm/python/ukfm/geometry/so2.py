...
class SO2:
    r"""Rotation matrix in :math:`SO(2)`.
    ...
    @classmethod
    def exp(cls, phi):
        r"""Exponential map for :math:`SO(2)`, which computes a transformation 
    ...
    def inv_left_jacobian(cls, phi):
        r""":math:`SO(2)` inverse left Jacobian.
    ...
    @classmethod
    def log(cls, Rot):
        r"""Logarithmic map for :math:`SO(2)`, which computes a tangent vector 
    ...
    @classmethod
    def wedge(cls, phi):
        r""":math:`SO(2)` wedge (skew-symmetric) operator.
